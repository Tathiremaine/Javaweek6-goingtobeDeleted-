...
public class week6 
{
		...
		public static void main(String[] args) 
		{
			...
			{
				System.out.println(player + "'s Turn -- enter a number for the square you want to place " + player + " on.");
				...
				if (squareNumber > 0 && squareNumber <= 9)
				{
					if(gameBoard.ifValidSetSquare(squareNumber, readInput, player))
					{
						...
						allSquares++;
						gameBoard.display();
						winner = gameBoard.checkWinSatus();
					}
					else
					{
						System.out.println("Square has allready been filled.");
					}
				}
